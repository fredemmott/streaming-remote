...
export namespace ClientConfigStorage {
  ...
  export function getSavedConfiguration(name: string): ClientConfig {
  ...
  export function saveConfiguration(name: string, config: ClientConfig): void {
    try {
